 ...
 */
public class DownloadGoAnnotationGexfFromUrlServlet extends HttpServlet {
    ...
    protected void servletLogic(HttpServletRequest request, HttpServletResponse resp)
        ...
        try {
            ...
            if (method.equals(RequestList.DOWNLOAD_GO_ANNOTATION_GEXF_FROM_URL_REQUEST)) {
                ...
                resp.setHeader("Content-Disposition", "attachment; filename=" + "GoAnnotation.gexf");
                
                byte[] byteArray = gexfResponseSt.getBytes();
                out.write(byteArray);
            ...
            //logging request
            //Bio4jLogger.log(Bio4jLogger.createLogRecord(request, myReq.toString(), RequestList.DOWNLOAD_GO_ANNOTATION_GEXF_FROM_URL_REQUEST));
